...
| POST | `/users/assign-role` | `{ username, role_name }` | Assign role to user by name |
| GET | `/users/me/roles` | — | Roles of the logged-in user |
| GET | `/users/me/permissions` | — | Permissions of the logged-in user |

Permissions are comma-separated strings, e.g. `"view,upload,edit"`.
